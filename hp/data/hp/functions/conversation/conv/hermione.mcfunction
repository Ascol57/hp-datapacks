...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"[{\"text\":\" Salut! Je suis \"},{\"text\":\"Hermione Granger\",\"color\":\"gold\",\"bold\":\"true\"},{\"text\":\".\\n\\n\\n\\n\\n\",\"color\":\"white\",\"bold\":\"false\"}]"}
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"≤ Comment se fait-il que tu ne sois pas à Serdaigle ?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≤ Qu'est-ce que spew ?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=3}] run data merge entity @s {CustomName:"{\"text\":\"≤ Parlez-moi de votre chat\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=4}] run data merge entity @s {CustomName:"{\"text\":\"≤ Êtes-vous né de parents moldus ?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=5}] run data merge entity @s {CustomName:"{\"text\":\"≥ Prends soin de toi\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Eh bien, le Choixpeau a sérieusement envisagé de me placer à Serdaigle lors de ma répartition, mais il a finalement opté pour Gryffondor. Je suppose que Serdaigle n'aurait pas été trop mal, mais j'ai toujours espéré être réparti à Gryffondor. Dumbledore lui-même était à Gryffondor. \\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" C'est la S.P.E.W ou la Société pour la Promotion du Bien-Être des Elfes. Vous savez, les elfes de maison sont maltraités ! J'ai donc fondé la S.P.E.W en réponse à l'injustice flagrante dont sont victimes les elfes de maison. Ils ne sont ni payés pour leur travail ni en vacances, alors je me bats pour changer leurs conditions de travail. \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Il s'appelle Crookshanks et il est vraiment très intelligent. Je l'ai acheté à la Ménagerie Magique du Chemin de Traverse. Il est magnifique je trouve, même si personne d'autre n'avait voulu l'acheter.\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Oui ! Mes deux parents sont des dentistes moldus, mais ils acceptent très bien le monde des sorciers. Ils ont été choqués quand nous avons découvert que j'étais une sorcière, mais ravis aussi.\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Oh wow ! Vraiment ? Bon, je suppose que je pourrais t'apprendre un sort, mais je suis un peu occupé en ce moment. Peut-être que si tu pouvais m'aider, j'aurais le temps de t'apprendre ?\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ Ce serait génial !\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≥ Il y a quelque chose que je dois faire en premier\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Super ! Peut-être avez-vous entendu parler de mon organisation, S.P.E.W ? J'essaie d'améliorer les conditions de travail des elfes de maison. Vous savez, les elfes de maison sont maltraités. Ils ne sont pas payés pour leur travail et n'ont pas de vacances non plus ! \\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" J'ai essayé de convaincre d'autres étudiants de Poudlard de rejoindre la cause, mais personne d'autre n'a été vraiment intéressé, et les elfes de maison semblent considérer toute l'initiative comme une insulte. J'espérais que le message trouverait un écho auprès des habitants du village voisin de Pré-au-Lard.. \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Peut-être pourriez-vous m'aider à mettre des dépliants à Pré-au-Lard pour faire passer le message ? \\n\\n Rendez-vous à Pré-au-Lard et accrochez les dépliants sur 5 panneaux d'affichage.\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ Je vais faire ça\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Revenez quand vous aurez mis tous les flyers.\\n\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"Il y a autre chose\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState 1
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"≥ˈˈ Ok\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=2}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState -1
#-------------------------------
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Avez-vous mis tous les dépliants ? \\n\\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ Je l'ai fait!\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Excellent. Je suppose que je peux t'apprendre maintenant. Il y a un sort qui m'a été utile à plusieurs reprises, bien qu'il soit de nature plus malicieuse. Il s'appelle 'Alohomora' et est utilisé pour déverrouiller les portes verrouillées. \\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Je connais un endroit où nous pouvons aller pour nous entraîner.\\n\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"√ Allons-y\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Excellent ! Vraiment bien fait. Le charme Alohomora est maintenant débloqué. \\n\\n\\n\\n \"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Je crois que ton prochain cours est de voler avec Madame Bibine. Es-tu prête à repartir ?\"}"}
# execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] if entity @p[tag=activePlayer,tag=!confirmConvOption,tag=!inMemory] run data merge entity @s {CustomName:"{\"text\":\"√ Voyage à la bibliothèque\"}",Tags:["_____Normal_____","_____click_____","fastTravel","_____destinationTheLibrary_____","convOption","i"]}
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] if entity @p[tag=activePlayer,tag=confirmConvOption,tag=!inMemory] run data merge entity @s {CustomName:"{\"text\":\"La Bibliothèque\"}",Tags:["_____Normal_____","_____click_____","fastTravel","_____destinationTheLibrary_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Pour utiliser le sort 'Alohomora', vous devez le sélectionner dans votre menu de sorts en appuyant sur ² et le lancer en double-cliquant sur ⌠ tout en regardant une porte verrouillée.\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Génial ! On peut se retrouver à la bibliothèque quand tu auras fini.\\n\\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"≥ Au revoir\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState -1
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Attendez que tout le monde soit prêt et nous y irons.\\n\\n\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" C'est très gentil. En fait, c'est le cas. J'ai parcouru la plupart des sections intéressantes de la bibliothèque de Poudlard et je cherche un peu de lecture supplémentaire. \\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Si vous trouvez des livres intéressants ou rares, apportez-les-moi.\\n\\n Je paierai 50 ≈ pour chaque livre rare que vous m'apporterez. \\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"ⁿ Je vais\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Cela a l’air intéressant… Cela devrait être une bonne lecture !  \\n\"}"}
execute if entity @s[tag=use] run scoreboard players set @s questTextTimer 2
execute as @s[scores={playerID=1},tag=use] run bossbar set minecraft:player1quest name ["",{"text":"Echanger ","color":"white"},{"score":{"name":"@s","objective":"rareBooks"},"color":"white"},{"text":" les livres rares pour ","color":"white"},{"score":{"name":"@s","objective":"rareBooksMoney"},"color":"white"},{"text":" ≈","color":"white"},{"text":".","color":"white"}]
execute as @s[scores={playerID=3},tag=use] run bossbar set minecraft:player3quest name ["",{"text":"Echanger ","color":"white"},{"score":{"name":"@s","objective":"rareBooks"},"color":"white"},{"text":" les livres rares pour ","color":"white"},{"score":{"name":"@s","objective":"rareBooksMoney"},"color":"white"},{"text":" ≈","color":"white"},{"text":".","color":"white"}]
execute as @s[scores={playerID=2},tag=use] run bossbar set minecraft:player2quest name ["",{"text":"Echanger ","color":"white"},{"score":{"name":"@s","objective":"rareBooks"},"color":"white"},{"text":" les livres rares pour ","color":"white"},{"score":{"name":"@s","objective":"rareBooksMoney"},"color":"white"},{"text":" ≈","color":"white"},{"text":".","color":"white"}]
execute as @s[scores={playerID=4},tag=use] run bossbar set minecraft:player4quest name ["",{"text":"Echanger ","color":"white"},{"score":{"name":"@s","objective":"rareBooks"},"color":"white"},{"text":" les livres rares pour ","color":"white"},{"score":{"name":"@s","objective":"rareBooksMoney"},"color":"white"},{"text":" ≈","color":"white"},{"text":".","color":"white"}]
...
################################
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=1}] run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ (Echanger les livres rares)\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=1}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState 1
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=2}] run data merge entity @s {CustomName:"{\"text\":\"Pas grave\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
execute as @s[tag=trg] as @e[type=armor_stand,limit=1,scores={con=2}] as @s[tag=convSelected] as @p[tag=activePlayer,scores={tmp=0}] store success score @s tmp run scoreboard players set @s convState 1
#-------------------------------
#===============================
# Number of options
