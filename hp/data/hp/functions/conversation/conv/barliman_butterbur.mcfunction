...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"[{\"text\":\" Pourquoi bonjour ! Je suis \"},{\"text\":\"Barliman Butterbur\",\"color\":\"gold\",\"bold\":\"true\"},{\"text\":\", le propriétaire de The Wine Barrel Inn. Comment puis-je vous aider ?\",\"color\":\"white\",\"bold\":\"false\"}]"}
